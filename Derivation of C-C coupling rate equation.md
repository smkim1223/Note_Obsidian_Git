...
$$
\begin{equation*}
\frac{r_{\text {self }}}{[L]}=\frac{\gamma_{*_{M-O}} k_{2} k_{4} K_{1} K_{3} a_{C_{3} H_{6} O}^{2}}{1} \tag{S.37}
\end{equation*}
$$
...
\frac{\gamma_{*_{M-O}} K_{1} K_{2} a_{C_{3} H_{6} O}}{\gamma_{_{(C_{3} H_{5} O-H)}*_{M-O}}}
+
\frac{\gamma_{*_{M-O}} K_{1} K_{2} K_{3} a_{C_{3} H_{6} O}^2}{\gamma_{_{(C_{3} H_{6} O)(C_{3} H_{5} O-H)}*_{M-O}}}
+
\frac{\gamma_{*_{M-O}} K_{1} K_{2} K_{9} a_{C_{3} H_{6} O} a_{C_{3} H_{6} O}}{\gamma_{_{(C_{3} H_{6} O)}*_{M-O}}}
)
