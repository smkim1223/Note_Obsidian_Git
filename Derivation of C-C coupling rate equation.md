...
$$
>[!note]
>Since the kinetically relevant step of C-C coupling in self-condensation, **$k_{9}$ and $k_{10}$ are associated with cross-aldol condensation, which can be neglected.** Therefore, we can simplify the rate equation (S.38) as following:
>$$
\begin{equation*}
