...
1. General procedure for running 
	...
	2. RMG input files
		...
		2. [Gitub](https://github.com/ReactionMechanismGenerator/RMG-Py) or [Github documentation](https://reactionmechanismgenerator.github.io/RMG-Py/users/rmg/input.html) 
		3. Documentation
